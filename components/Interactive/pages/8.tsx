...
const InteractivePage = () => {
  ...
  return (
    <BackgroundVideo page="8" videoType={userChoicePage6} loop muted autoPlay>
      <VStack gap={3.5}>
        <Typography
          component="div"
          variant="h3"
        ...
        >
          ...
          <Box display="inline" fontWeight="500">{` (มีสีฟ้าดูเศร้าซึม) `}</Box>{" "}
          ที่
          <Box
            display="inline"
            fontWeight="500"
          ...
          และควบแน่นที่
          <Box display="inline" fontWeight="500">{` (ตรงหัวใจของฉัน) `}</Box>
          คงเป็นเพราะว่า ………
        </Typography>
        <Box
          component="form"
