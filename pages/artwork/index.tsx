						...
						<ListItem>
							...
							>
								...
								<Typography fontSize="14px" fontWeight="bold">
									LITERATURE and PERFORMANCE ART is not
									competitive anymore. Submissions will still
									recieve a feedback and a display on the
									Artspect Instagram.
								</Typography>
								<Typography fontSize="14px" fontWeight="bold">
									ONLY VISUAL ART WILL BE COMPETITIVE
								</Typography>
							</Box>
						</ListItem>
						<ListItem>
				...
				<Grid item sm={5}>
					...
					<List>
						...
						<ListItem>
							...
							>
								ทักษะทางด้านศิลปะเป็นเพียงส่วนหนึ่ง
								ของการตัดสินเท่านั้น
							</Typography>
						</ListItem>
						<ListItem>
							<ListItemIcon>
							...
							>
								ผลงานของคุณอาจเป็นส่วนช่วยสร้างแรงบันดาลใจ
								ให้กับผู้ชม
							</Typography>
						</ListItem>
					</List>
				...
				<Grid item sm={6}>
					...
					<List>
						<ListItem>
							...
							>
								ผลงานศิลปะ 24 ชิ้น จะถูกเลือกเพื่อนำไปจัดแสดง
								(ประเภทละ 8 ชิ้น)
								กรรมการจากผู้สนับสนุนโครงการจะเป็นผู้เลือกผลงาน
						...
						<ListItem>
							...
							>
								1 ผลงานจะผลงาน 1
								ชิ้นจะมาจากผลโหวตของประชาชนทั่วไป
