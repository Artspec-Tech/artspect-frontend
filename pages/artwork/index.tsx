...
import { Typography, Button, Grid, List, ListItem, ListItemIcon, Box } from "@mui/material";
        ...
        <Grid container spacing={6}>
          ...
          <Grid item sm={5}>
            ...
            >
              ...
              <Button variant="contained" href="https://docs.google.com/forms/d/e/1FAIpQLSfBipAD8tFkD_QMNoV7K0p7omYkTZQr_B5zbLxFg1-Tnr_HwQ/viewform" sx={{borderRadius: 10, backgroundColor: "#FF0000"}}>SUBMIT NOW</Button>
            </Box>
          </Grid>
          <Grid item sm={7}>
            <Box sx={{
          ...
          <Grid item sm={5}>
              ...
              <List>
                <ListItem>
                  <ListItemIcon>
                    <CircleIcon sx={{height: '5px', width: '5px', marginTop:'-20px', color: "#000000"}} />
                  </ListItemIcon>
                  <Typography sx={{lineHeight: '2.2rem', marginLeft: '-30px'}}>
                    Artspect ให้ความสำคัญกับเรื่องราวและ การสื่อความผ่านผลงานเป็นหลัก
                  </Typography>
                </ListItem>
                <ListItem>
                  <ListItemIcon>
          ...
          <Grid item sm={6}><SubmissionDetail /></Grid>
          <Grid item sm={6}>
              <Typography
                fontSize={{
                  xs: '18px',
              ...
              <List>
                <ListItem>
                  ...
                  <Typography sx={{lineHeight: '2.2rem', marginLeft: '-30px'}}>
                  ผลงานศิลปะ 24 ชิ้น จะถูกเลือกเพื่อนำไปจัดแสดง (ประเภทละ 8 ชิ้น) กรรมการจากผู้สนับสนุนโครงการจะเป็นผู้เลือกผลงาน 1 ชิ้นจากแต่ละประเภท
                  </Typography>
                </ListItem>
                <ListItem>
                  <ListItemIcon>
                    <CircleIcon sx={{height: '5px', width: '5px', marginTop:'-38px', color: "#000000"}} />
                  </ListItemIcon>
                  <Typography sx={{lineHeight: '2.2rem', marginLeft: '-30px'}}>
                    1 ผลงานจะผลงาน 1 ชิ้นจะมาจากผลโหวตของประชาชนทั่วไป (ผลงานทั้งหมดจะถูกเผยแพร่บนเว็บไซต์ของเราและประชาชนทั่วไปสามารถร่วมโหวตผลงานได้ 1 ชิ้นจากแต่ละประเภท)
                  </Typography>
                </ListItem>
                <ListItem>
                  <ListItemIcon>
